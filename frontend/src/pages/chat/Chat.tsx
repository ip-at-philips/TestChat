                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Ask me a question</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This system is configured to answer your questions regarding data from CI&I</h2>
                            </Stack>
                        ) : (
